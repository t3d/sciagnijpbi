...
#
#spis tresci:
#http://www.pbi.edu.pl/book_reader.php?p=55003&s=1    robinson c
...
# http://www.pbi.edu.pl/left_1.php?p=55003&s=&w=
#var pages = 846
#publikacje/0000/050/620/0000050620-000003.jpg
#$ echo "<form id="img"><img src="publikacje/0000/055/003/0000055003-000001.jpg" width="1619" height="2419" id=imgview >
#</form>" | sed 's/.*src=\(.*\).jpg.*/\1/'
#publikacje/0000/055/003/0000055003-000001
...
#	return
#echo wget $1
#echo local file: $dir/$2.jpg

wget -o $dir/log.tmp -O"$dir/$2.jpg" "$1" &
...
scrpattern=`cat $dir/$file.html|grep publik|sed 's/.*src="\(.*\)-.*/\1/'`
echo $scrpattern
